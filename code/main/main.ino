...
// Đếm màu sắc
int sp1 = 0, sp2 = 0, sp3 = 0, tongsp = 0;
bool khoaDem1 = 0, khoaDem2 = 0, khoaDem3 = 0;
...
void ReadCB(){
  ...
  //Serial.print(sp1); Serial.print(" - "); Serial.print(sp2); Serial.print(" - "); Serial.print(spY); Serial.print(" - "); Serial.println(tongsp);
}
...
void hienThi(){
  ...
  lcd.setCursor(2,1); lcd.print(sp1);

  // Xanh
  lcd.setCursor(5,1); lcd.print("G:");
  lcd.setCursor(7,1); lcd.print(sp2);

  // Vàng
  lcd.setCursor(10,1); lcd.print("P:");
  lcd.setCursor(12,1); lcd.print(sp3);
}
...
void readColor(){
  ...
  //case
  if(r >= 35 && r <= 45 && g >= 40 && g <= 60 && b >= 45 && b <= 60){
    color = 1;      //vàng
  }
  else if(r >= 40 && r <= 65 && g >= 65&& g <= 80 && b >= 40 && b <= 49){
    color = 2;      // hồng
  }
  else if(r >= 50 && r <= 65 && g >= 55 && g <= 64 && b >= 50 && b <= 60){
    color = 3;      // Xanh
  }
  else color = 0;      // ko có
}
